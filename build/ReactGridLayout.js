    ...
    value: function componentDidMount() {
      ...
      this.props.dragApiRef.value = {
        dragIn: function dragIn(_ref2) {
          ...
          var _calcXY = (0, _calculateUtils.calcXY)(position.top, position.left, {
          ...
          if (!_this2.state.activeDrag) {
            ...
            _this2.setState({
              oldDragItem: l,
              oldLayout: layout,
              layout: [].concat(_toConsumableArray(_this2.state.layout), [l]),
              activeDrag: l
            });
        ...
        dragOut: function dragOut(_ref3) {
        ...
        stop: function stop(_ref4) {
          ...
          if (dragInfo) {
            ...
            var _calcXY2 = (0, _calculateUtils.calcXY)(position.top, position.left, {
              containerWidth: _this2.props.width,
              cols: _this2.props.cols,
              margin: margin,
              containerPadding: containerPadding || margin,
