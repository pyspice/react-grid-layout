      ...
      var u =
        ...
        w = (function(t) {
          ...
          return (
                ...
                this.props.dragApiRef.value,
                {
                  dragIn: function(n) {
                    var r = n.layout,
                      ...
                      h = t.props,
                      y = h.margin,
                      g = h.containerPadding,
                      m = (0, v.calcXY)(p.top, p.left, {
                        containerWidth: t.props.width,
                        cols: t.props.cols,
                        margin: y,
                        containerPadding: g || y,
                    ...
                    if (
                      ...
                      t.onDrag(a, b, w, { e: f, node: c, newPosition: p });
                    else {
                      var x = u({ i: a, w: i, h: s }, l, { x: b, y: w });
                      t.setState({
                        oldDragItem: x,
                        oldLayout: d,
                        ...
                        t.props.onDragStart(d, x, x, null, f, c);
                    }
                  },
                  dragOut: function() {
                    if (e) {
                  ...
                  getLayout: function() {
                    return (0, m.cloneLayout)(t.state.layout);
                  },
                  stop: function(n) {
                    var r = n.i,
                      o = n.event,
                    ...
                    if (e) {
                      var i = e,
                        ...
                        f = t.props,
                        p = f.margin,
                        d = f.containerPadding,
                        h = (0, v.calcXY)(a.top, a.left, {
                          containerWidth: t.props.width,
                          cols: t.props.cols,
                          margin: p,
            ...
            (e.prototype.onDragStop = function(t, e, n, r, o) {
              var a = r.e,
                i = r.node,
              ...
              if (p) {
                (u = (0, m.moveElement)(
                  ...
                  o && (p.i = o),
                  this.props.onDragStop(u, s, p, null, a, i);
                var d = (0, m.compact)(u, this.compactType(), c),
            ...
            (e.prototype.onResize = function(t, e, n, r) {
              ...
              if (d) {
                ...
                this.props.onResize(s, l, d, b, o, a),
                  this.setState({
      ...
      var u =
        ...
        w = (function(t) {
          ...
          return (
            ...
            (e.prototype.componentDidMount = function() {
              var t = this;
              this.props.dragApiRef.value = u({}, this.props.dragApiRef.value, {
                getBreakpoint: function() {
                  return t.state.breakpoint;
                }
              });
            }),
            (e.prototype.componentWillReceiveProps = function(t) {
            ...
            (e.prototype.onWidthChange = function(t) {
              ...
              if (
                ...
                (u = (0, y.synchronizeLayoutWithChildren)(u, t.children, s, o)),
                  (r[a] = u),
                  this.props.onLayoutChange(u, r, a),
